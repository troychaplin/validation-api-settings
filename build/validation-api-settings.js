					...
					filterText: ( t, i ) =>
						( 0, e.createInterpolateElement )(
							( 0, n.sprintf )(
								...
								/* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is none of: Admin, Editor". */
								( 0, n.__ )( '<Name>%1$s is none of: </Name><Value>%2$s</Value>' ),
								t.name,
						...
						filterText: ( t, i ) =>
							( 0, e.createInterpolateElement )(
								( 0, n.sprintf )(
									...
									/* translators: 1: Filter name (e.g. "Date"). 2: Filter value (e.g. "7 days"): "Date is over: 7 days". */
									( 0, n.__ )( '<Name>%1$s is over: </Name><Value>%2$s</Value>' ),
									t.name,
									`${ i[ 0 ].value.value } ${ i[ 0 ].value.unit }`
								),
								Mi
						...
						filterText: ( t, i ) =>
							( 0, e.createInterpolateElement )(
								( 0, n.sprintf )(
									...
									/* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is: Admin". */
									( 0, n.__ )( '<Name>%1$s is: </Name><Value>%2$s</Value>' ),
									t.name,
									i[ 0 ].label
								),
								Mi
						...
						filterText: ( t, i ) =>
							( 0, e.createInterpolateElement )(
								( 0, n.sprintf )(
									...
									/* translators: 1: Filter name (e.g. "Author"). 2: Filter value (e.g. "Admin"): "Author is not: Admin". */
									( 0, n.__ )( '<Name>%1$s is not: </Name><Value>%2$s</Value>' ),
									t.name,
									i[ 0 ].label
								),
								Mi
			...
			function Vc( {
				...
				const a = o
					? ( 0, e.createInterpolateElement )(
							...
							// translators: %s: The label of the field e.g. "Status".
							( 0, n.sprintf )( ( 0, n.__ )( '%s: <groupName />' ), r.label ).trim(),
